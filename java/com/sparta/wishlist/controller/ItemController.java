...
public class ItemController {
    ...
    /**
     * API 엔드포인트 (POST /items) : 새 찜 상품 생성
    ...
    /**
     * API 엔드포인트 (GET /items) : 전체 찜 상품 목록 조회
     *
    ...
    /**
     * API 엔드포인트 (GET /items/{id}) : 찜 상품 단건 조회
     *
    ...
    /**
     * API 엔드포인트 (PUT /items/{id}) : 기존 찜 상품 수정
     * 요청 Body(@RequestBody)의 유효성(@Valid)을 검사합니다.
     *
    ...
    /**
     * API 엔드포인트 (DELETE /items/{id}) : 찜 상품 삭제
     *
